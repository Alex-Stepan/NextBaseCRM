...
public class ResetPasswordByLogin extends DriverTestBase {


    @When("Use Login to reset password")
    public void use_login_to_reset_password() throws InterruptedException {
        ...
        //7. Navigate to LoginBox & input username from the List:
            actions.click(getPasswordPage.LoginBox).perform();
                Thread.sleep(2000);
            actions.sendKeys(loginList.get(1)).perform();
                Thread.sleep(2000); //2000 = 2 sec

        //8.
        actions.moveToElement(getPasswordPage.ResetPasswordButton).click().perform();
        Thread.sleep(3000);
        ...
        //10.
        Thread.sleep(2000);
        actions.moveToElement(getPasswordPage.AuthorizationLinkFromLogin).click().perform();
        Thread.sleep(2000);
