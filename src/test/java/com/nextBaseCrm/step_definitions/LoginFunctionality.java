package com.nextBaseCrm.step_definitions;
    ...
    import com.nextBaseCrm.pages.HRHomePage;
    import com.nextBaseCrm.pages.HelpDeskHomePage;
    import com.nextBaseCrm.pages.MarketingHomePage;
...
public class LoginFunctionality extends DriverTestBase {
            ...
            public void user_is_on_default_page() throws InterruptedException {
    ...
    public void user_verifies_login_functionalities() throws InterruptedException {
        ...
        ArrayList<String> loginList = new ArrayList<>();
            ...
            //5. pages authorization for using in this class
